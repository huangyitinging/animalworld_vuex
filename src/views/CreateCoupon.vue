...
export default {
    ...
    methods: {
        getCoupons(page = 1){
            const vm = this;
            const url = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMAPIPATH}/admin/coupons?page=${page}`;
            const coupon={
                code:vm.coupon_code,
            };
        ...
        updateCoupon(){
            let api =`${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMAPIPATH}/admin/coupon`; //'https://vue-course-api.hexschool.io/api/hexschooleating/products';
            let httpMethod = 'post';
            const vm =this;
            if(!vm.isNew){
                api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMAPIPATH}/admin/coupon/${vm.tempCoupon.id}`; 
                httpMethod = 'put'
            }
        ...
        delCoupon(){
            const vm = this;
            const api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMAPIPATH}/admin/coupon/${vm.tempCoupon.id}`;
